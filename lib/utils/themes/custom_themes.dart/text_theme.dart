...
class JTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 17.0,fontWeight: FontWeight.w600,color: Colors.black.withOpacity(0.7) ),
  
    titleLarge: const TextStyle().copyWith(fontSize: 16.0,fontWeight: FontWeight.w600,color: Colors.black ),
    titleMedium: const TextStyle().copyWith(fontSize: 15.0,fontWeight: FontWeight.w500,color: Colors.black ),
    titleSmall: const TextStyle().copyWith(fontSize: 15.0,fontWeight: FontWeight.w400,color: Colors.black ),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 13.0,fontWeight: FontWeight.w500,color: Colors.black.withOpacity(0.5) ),

    labelLarge: const TextStyle().copyWith(fontSize: 13.0,fontWeight: FontWeight.normal,color: Colors.black ),
    labelMedium: const TextStyle().copyWith(fontSize: 13.0,fontWeight: FontWeight.normal,color: Colors.black.withOpacity(0.5) ),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 13.0,fontWeight: FontWeight.normal,color: Colors.white ),
    labelMedium: const TextStyle().copyWith(fontSize: 13.0,fontWeight: FontWeight.normal,color: Colors.white.withOpacity(0.5) ),
  );
}
